...
var Meeting = /** @class */ (function () {
    ...
    Meeting.fromMap = function (data) {
        return new Meeting(data.meetingId, data.startDate, data.endDate, data.participants, data.gameInstanceId, data.meetingInfo, participant_1.Participant.fromMap(data.host));
    };
    Meeting.fromFirestore = function (snap) {
        ...
        return Meeting.fromMap(__assign(__assign({ meetingId: snap.id }, snap.data()), { startDate: startDate, endDate: endDate }));
    };
    Meeting.prototype.toMap = function () {
        ...
        return {
            ...
            host: (_g = this.host) !== null && _g !== void 0 ? _g : null,
        };
    };
    return Meeting;
}());
